...
void sfFontRenderer::setRotation(double rotation)
{
    m_rotation = rotation;
}

double sfFontRenderer::getRotation()
{
    return m_rotation;
}

void sfFontRenderer::setTransparency(double transparency)
{
    m_transparency = transparency;
}

double sfFontRenderer::getTransparency()
{
